  ...
  return (
    <section className="bg-white text-ink">
      <div className="mx-auto max-w-7xl px-6 pt-40 md:pt-48 pb-24 grid lg:grid-cols-2 gap-14 lg:gap-20 items-start">
        ...
        <div>
          <Reveal><p className="text-jkred font-semibold tracking-wide text-sm mb-5">Get in touch</p></Reveal>
          <Reveal delay={0.05}>
            <h1 className="font-display font-extrabold leading-[1.02]" style={{ fontSize: "clamp(2rem,4.6vw,3.5rem)", letterSpacing: "-0.02em" }}>
        ...
        <Reveal dir="left" delay={0.1} className="lg:pt-4">
          <div>
